...
const ProductCard = ({ data }) => {
  return (
    <>
      <div className="group rounded-2xl border border-gray-300 hover:border-primary_color shadow-md p-4 bg-slate-100 backdrop-blur-lg relative hover:shadow-green-200 duration-300 overflow-hidden">
        ...
        <Link
          href={`/shop/${data?.id}`}
          className="mt-4 hover:text-primary_color duration-200"
        >
